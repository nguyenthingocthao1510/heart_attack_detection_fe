...
class PatientRecordHistoryPage extends StatefulWidget {
  const PatientRecordHistoryPage({super.key});

  @override
  State<PatientRecordHistoryPage> createState() =>
      _PatientRecordHistoryPageState();
}

class _PatientRecordHistoryPageState extends State<PatientRecordHistoryPage> {
  List<historyPatientPatientRecord> patientRecords = [];
  ...
  Future<void> getAllPatientRecord() async {
    ...
    final response =
        await PatientPatientRecordAPI.getPatientHistoryPatientRecord(
            int.parse(accountId!));
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Patient record history'),
      ),
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PatientRecordHistoryPage()));
                  },

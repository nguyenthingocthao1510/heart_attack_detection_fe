...
import 'package:heart_attack_detection_fe/pages/patient/Diagnosis/Prediction/ProcessPrediction/index.dart';
...
void main() {
  testWidgets('Preview enteringInformation page', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: ProcessPrediction(), // or '0' to test the other page
    ));
